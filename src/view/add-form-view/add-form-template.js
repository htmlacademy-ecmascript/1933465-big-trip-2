...
function createOfferTemplate(offer, id, isChecked = false) {
  const { title, price, id: offerId } = offer;
  return `<div class="event__offer-selector">
                        <input class="event__offer-checkbox  visually-hidden" id="event-offer-${offerId}-${id}" type="checkbox" name="event-offer-${offerId}" ${isChecked ? 'checked' : ''}>
